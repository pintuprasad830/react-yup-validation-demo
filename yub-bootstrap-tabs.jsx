        ...
        <div className="container-fluid">
            ...
            <form className="mt-3" onSubmit={formik.handleSubmit} noValidate>
                ...
                <ul className="nav nav-tabs">
                    ...
                    <li className="nav-item"><a href="#personal" data-bs-toggle="tab" className="nav-link active">Personal Details</a></li>

                    <li className="nav-item"><a href="#contact" data-bs-toggle="tab" className="nav-link">Contact Details</a></li>

                    <li className="nav-item"><a href="#summary" data-bs-toggle="tab" className="nav-link">Summary</a></li>
